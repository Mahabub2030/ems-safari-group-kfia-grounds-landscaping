...
export default function Employees() {
 const canEdit = true;
 const [employees, setEmployees] = useState<MockEmployee[]>(employeeData);
 ...
 const columns: Column<MockEmployee>[] = [
  ...
  },
  {
   ...
   render: (emp) => (
    <span
     className={`text-[11px] px-2 py-0.5 rounded-full border font-semibold inline-block text-center ${statusBadge[emp.status] || "bg-slate-100 text-slate-700"
      }`}
    >
     {emp.status}
    </span>
